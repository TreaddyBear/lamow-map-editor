  ...
  return (
    <RadixDialog.Root open={open} onOpenChange={onOpenChange}>
      <RadixDialog.Portal>
        ...
        <RadixDialog.Content className="fixed left-1/2 top-1/2 z-[31] grid max-h-[min(34rem,calc(100vh-2rem))] w-[min(28rem,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 grid-rows-[auto_minmax(0,1fr)] overflow-hidden rounded-lg border border-[#b8c9b2] bg-[#f8fbf6] shadow-[0_18px_60px_rgb(31_49_27_/_24%)]" aria-describedby={undefined}>
          <div className="flex items-center justify-between gap-4 border-b border-[#d8e3d3] px-3 py-2.5">
